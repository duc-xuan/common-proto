...
const file_user_proto_user_proto_rawDesc = "" +
	...
	"\vUserService\x12K\n" +
	"\n" +
	"CreateUser\x12\x1d.user_proto.CreateUserRequest\x1a\x1e.user_proto.CreateUserResponseB\x13Z\x11user-proto/userpbb\x06proto3"
...
var file_user_proto_user_proto_depIdxs = []int32{
	0, // 0: user_proto.UserService.CreateUser:input_type -> user_proto.CreateUserRequest
	1, // 1: user_proto.UserService.CreateUser:output_type -> user_proto.CreateUserResponse
